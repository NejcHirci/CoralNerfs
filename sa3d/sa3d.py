...
from seathru.seathru_model import SeathruModelConfig, SeathruModel
...
from seathru import SeathruRGBRenderer, SeathruDepthRenderer, SeathruField, SeathruHeadNames
from sa3d.sa3d_field import TCNNMaskFieldConfig


@dataclass
class SA3DSeathruModelConfig(SeathruModelConfig):
    ...
    _target: Type = field(default_factory=lambda: SA3DSeathruModel)


class SA3DSeathruModel(SeathruModel):
    """ Model for SA3D with Seathru."""
    ...
    def populate_modules(self):
        ...
        # This model should not be in training mode
        self.eval()
    ...
    def get_outputs(self, ray_bundle: RayBundle, use_direct: bool = False):
        with torch.no_grad():
